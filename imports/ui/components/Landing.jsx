          ...
          <div className="centered-text">
            <div className="section no-pad-bot" id="index-banner">
              <div className="container-fluid" style={{ marginBottom: '47%' }}>
                <h1 className="header center blue-text lighten-2">SparkEd Platform</h1>
            ...
            <div className="row">
              <div className="col s12 m4 ">
                <div className="icon-block">
                  ...
                  <p className="light">Customize and Organize Educational contents</p>
                </div>
              </div>
              ...
              <div className="col s12 m4 ">
                <div className="icon-block">
                  ...
                  <p className="light">
                    Ability to organize books and allow users to read according to their courses
                  </p>
                </div>
              </div>
